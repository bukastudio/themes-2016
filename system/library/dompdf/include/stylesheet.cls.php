...
//     $selector = preg_replace($search, $replace, trim($selector));
    ...
    while ( $i < $len ) {
      ...
      case ":":
        ...
        case "first-line": // Todo-note
        case "first-letter": // Todo-note
      ...
      case "[":
        ...
        case "~=":
          // Fixme-note: this will break if $value contains quoted strings
...
//    }
  ...
  function apply_styles(Frame_Tree $tree) {
    ...
    // Fixme-note: this is not particularly robust...
  ...
  private function _parse_css($str) {
    ...
    // Fixme-note: handle '{' within strings, e.g. [attr="string {}"]
    ...
    foreach ( $matches as $match ) {
      ...
      if ( $match[2] !== "" ) {
        ...
        case "page":
          ...
          // Note-note: This has a reduced syntax:
  ...
  protected function _image($val) {
    ...
    if ( mb_strpos($val, "url") === false ) {
      ...
      if ( $parsed_url["protocol"] == "" && $this->get_protocol() == "" ) {
        ...
        // Fixme-note: Is this causing problems for imported CSS files? There are some './none' references when running the test cases.
        if (!$path) { $path = 'none'; }
      } else {
  ...
  private function _parse_import($url) {
    ...
    if ( $accept ) {
      ...
      // Todo-note: As above, do we need to replace php or file to an empty protocol for local files?
