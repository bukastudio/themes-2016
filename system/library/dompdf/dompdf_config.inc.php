...
// Fixme-note: Some function definitions rely on the constants defined by DOMPDF. However, might this location prove problematic?
 ...
 *
 * Note-note this directory must be writable by the webserver process
 ...
 * Note-note: aural is deprecated in CSS 2.1 because it is replaced by speech in CSS 3.
 * Note-note, even though the generated pdf file is intended for print output,
