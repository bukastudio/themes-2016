      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="ipaymu_merchant" value="<?php echo $ipaymu_merchant; ?>" />
          ...
          <tr>
            ...
            <td><input type="text" name="ipaymu_paypal" value="<?php echo $ipaymu_paypal; ?>" />
              <?php if ($error_paypal) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="ipaymu_rate" value="<?php echo $ipaymu_rate; ?>" />
              <?php /* if ($error_ipaymu_rate) { ?>
              <span class="error"><?php echo $error_ipaymu_rate; ?></span>
              <?php } */ ?></td>
          </tr>
          <tr>
            <td><?php echo $entry_invoice; ?></td>
            <td><input type="text" name="ipaymu_inv_paypal" value="<?php echo $ipaymu_inv_paypal; ?>" />
          ...
          <tr>
            ...
            <td><input type="text" name="ipaymu_total" value="<//?php echo //$ipaymu_total; ?>" /></td>
          </tr>-->
          <tr>
