...
<!-- start SMS Module -->
		  	<?php if ($entry_notifysmsstatussms) { ?>
				<?php if ($entry_notifysmsdefaultsms) { ?>
					<tr>			
					<td><?php echo $entry_notifysms; ?></td>
					<td><input type="checkbox" name="notifysms" value="1" checked="checked"  /><input type="textbox" name="telephone" value=<?php echo $telephone; ?> /></td>
					</tr>		
				<?php } else { ?>
					<tr>			
					<td><?php echo $entry_notifysms; ?></td>
					<td><input type="checkbox" name="notifysms" value="0" /><input type="textbox" name="telephone" value=<?php echo $telephone; ?> /></td>
					</tr>						
				<?php } ?>
		    <?php } ?>	
<!-- end SMS Module -->
