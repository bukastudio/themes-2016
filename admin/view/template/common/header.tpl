    ...
    <ul class="left" style="display: none;">
      ...
      <li id="pos" class=""><a class="top">Point Of Sale</a>
        <ul style="display: none; visibility: hidden;">
          ...
          <li><a href="index.php?route=pos/dashboard&token=<?php echo $this->session->data['token'] ?>">Dashboard</a></li>
          <li><a href="index.php?route=pos/settings&token=<?php echo $this->session->data['token'] ?>">Settings</a></li>
        </ul>
      </li>
      <!-- End Bukatoko -->
