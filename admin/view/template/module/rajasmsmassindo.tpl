...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a id="button-send" onclick="send('index.php?route=module/rajasmsmassindo/send&token=<?php echo $token; ?>');" class="button"><span><?php echo $button_send; ?></span></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><span><?php echo $button_cancel; ?></span></a></div>
    </div>
    <div class="content">
        <table id="mail" class="form">
          ...
          <tr>
            ...
            <td><textarea rows="3" cols="60" name="message"></textarea></td>
          </tr>
        </table>
    </div>
  </div>
