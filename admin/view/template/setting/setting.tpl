    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-store">
          ...
          <table class="form">
            <tr>
              <td><?php echo $entry_header_home; ?></td>
              <td><?php if ($config_header_home) { ?>
                <input type="radio" name="config_header_home" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_header_home" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_header_home" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_header_home" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_header_new_arrivals; ?></td>
              <td><?php if ($config_header_new_arrivals) { ?>
                <input type="radio" name="config_header_new_arrivals" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_header_new_arrivals" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_header_new_arrivals" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_header_new_arrivals" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_header_shop_by_brand; ?></td>
              <td><?php if ($config_header_shop_by_brand) { ?>
                <input type="radio" name="config_header_shop_by_brand" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_header_shop_by_brand" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_header_shop_by_brand" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_header_shop_by_brand" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_header_special; ?></td>
              <td><?php if ($config_header_special) { ?>
                <input type="radio" name="config_header_special" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_header_special" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_header_special" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_header_special" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_header_blog; ?></td>
              <td><?php if ($config_header_blog) { ?>
                <input type="radio" name="config_header_blog" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_header_blog" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_header_blog" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_header_blog" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
          </table>
          ...
          <table class="form">
            <tr>
              <td><?php echo $entry_footer_shop_by_brand; ?></td>
              <td><?php if ($config_footer_shop_by_brand) { ?>
                <input type="radio" name="config_footer_shop_by_brand" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_shop_by_brand" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_footer_shop_by_brand" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_shop_by_brand" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_footer_gift_voucher; ?></td>
              <td><?php if ($config_footer_gift_voucher) { ?>
                <input type="radio" name="config_footer_gift_voucher" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_gift_voucher" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_footer_gift_voucher" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_gift_voucher" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_footer_affiliate; ?></td>
              <td><?php if ($config_footer_affiliate) { ?>
                <input type="radio" name="config_footer_affiliate" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_affiliate" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_footer_affiliate" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_affiliate" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_footer_special; ?></td>
              <td><?php if ($config_footer_special) { ?>
                <input type="radio" name="config_footer_special" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_special" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_footer_special" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_special" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_footer_return; ?></td>
              <td><?php if ($config_footer_return) { ?>
                <input type="radio" name="config_footer_return" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_return" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_footer_return" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_return" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_footer_testimonial; ?></td>
              <td><?php if ($config_footer_testimonial) { ?>
                <input type="radio" name="config_footer_testimonial" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_testimonial" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_footer_testimonial" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_testimonial" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_footer_blog; ?></td>
              <td><?php if ($config_footer_blog) { ?>
                <input type="radio" name="config_footer_blog" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_blog" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_footer_blog" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_footer_blog" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
          </table>
        ...
        <div id="tab-option">
          ...
          <table class="form">
            <tr>
              <td><span class="required">*</span> Catalog Size</td>
              <td>
                <select name="config_catalog_size">
                  <?php if($config_catalog_size == "medium") { ?>
                    <option value="">Small (Default)</option>
                    <option value="medium" selected="selected">Medium</option>
                    <option value="large">Large</option>
                  <?php } elseif($config_catalog_size == "large") { ;?>
                    <option value="">Small (Default)</option>
                    <option value="medium">Medium</option>
                    <option value="large" selected="selected">Large</option>
                  <?php } else { ;?>
                    <option value="" selected="selected">Small (Default)</option>
                    <option value="medium">Medium</option>
                    <option value="large">Large</option>
                  <?php } ;?>
                  </select>
            ...
            <tr>
          	...
          	<tr>
          		<td><?php echo $entry_display_option_value; ?></td>
              <td><?php if ($config_display_option_value) { ?>
                <input type="radio" name="config_display_option_value" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_option_value" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_display_option_value" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_option_value" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
          	</tr>
          </table>
          ...
          <table class="form">
            ...
            <!-- Bukatoko -->
            <tr>
              <td><?php echo $view_timer; ?></td>
              <td><?php if ($config_timer) { ?>
                <input type="radio" name="config_timer" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_timer" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_timer" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_timer" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td>Display Info Box on Product Page</td>
              <td><?php if ($config_attributes_on_product_page) { ?>
                <input type="radio" name="config_attributes_on_product_page" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_attributes_on_product_page" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_attributes_on_product_page" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_attributes_on_product_page" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <!-- End -->
