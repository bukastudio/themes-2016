...
class ControllerReportAdvSaleProfit extends Controller { 
	public function index() { 			
		...
		$this->data['coupon_names'] = $this->model_report_adv_sale_profit->getOrderCouponns();
		...
		$this->data['coupon_codes'] = $this->model_report_adv_sale_profit->getOrderCouponns();
		...
		$this->data['voucher_codes'] = $this->model_report_adv_sale_profit->getOrderVouchers();
		...
		foreach ($results as $result) {
			...
			if ($result['prod_costs']) {
				$profit_margin_percent = ($result['sub_total']+$result['handling']+$result['low_order_fee']+$result['reward']+$result['coupon']+$result['credit']+$result['voucher']) > 0 ? round(100 * ((($result['sub_total']+$result['handling']+$result['low_order_fee']+$result['reward']+$result['coupon']+$result['credit']+$result['voucher']+($this->data['adv_profit_reports_formula_sop1'] ? $result['shipping'] : 0))-($result['prod_costs']+$result['commission']+($this->data['adv_profit_reports_formula_sop3'] ? $result['payment_cost'] : 0)+($this->data['adv_profit_reports_formula_sop2'] ? $result['shipping_cost'] : 0))) / ($result['sub_total']+$result['handling']+$result['low_order_fee']+$result['reward']+$result['coupon']+$result['credit']+$result['voucher']+($this->data['adv_profit_reports_formula_sop1'] ? $result['shipping'] : 0))), 2) . '%' : '';
				$profit_margin_total_percent = ($result['sub_total_total']+$result['handling_total']+$result['low_order_fee_total']+$result['reward_total']+$result['coupon_total']+$result['credit_total']+$result['voucher_total']) > 0 ? round(100 * ((($result['sub_total_total']+$result['handling_total']+$result['low_order_fee_total']+$result['reward_total']+$result['coupon_total']+$result['credit_total']+$result['voucher_total']+($this->data['adv_profit_reports_formula_sop1'] ? $result['shipping_total'] : 0))-($result['prod_costs_total']+$result['commission_total']+($this->data['adv_profit_reports_formula_sop3'] ? $result['pay_costs_total'] : 0)+($this->data['adv_profit_reports_formula_sop2'] ? $result['ship_costs_total'] : 0))) / ($result['sub_total_total']+$result['handling_total']+$result['low_order_fee_total']+$result['reward_total']+$result['coupon_total']+$result['credit_total']+$result['voucher_total']+($this->data['adv_profit_reports_formula_sop1'] ? $result['shipping_total'] : 0))), 2) . '%' : '';						
			} else {
			...
			$this->data['orders'][] = array(
				...
				'total_sales'      				=> $this->currency->format($result['sub_total']+$result['handling']+$result['low_order_fee']+$result['reward']+$result['coupon']+$result['credit']+$result['voucher']+($this->data['adv_profit_reports_formula_sop1'] ? $result['shipping'] : 0), $this->config->get('config_currency')),
				...
				'total_costs'      				=> $this->currency->format('-' . ($result['prod_costs']+$result['commission']+($this->data['adv_profit_reports_formula_sop3'] ? $result['payment_cost'] : 0)+($this->data['adv_profit_reports_formula_sop2'] ? $result['shipping_cost'] : 0)), $this->config->get('config_currency')),
				'netprofit'      				=> $this->currency->format(($result['sub_total']+$result['handling']+$result['low_order_fee']+$result['reward']+$result['coupon']+$result['credit']+$result['voucher']+($this->data['adv_profit_reports_formula_sop1'] ? $result['shipping'] : 0))-($result['prod_costs']+$result['commission']+($this->data['adv_profit_reports_formula_sop3'] ? $result['payment_cost'] : 0)+($this->data['adv_profit_reports_formula_sop2'] ? $result['shipping_cost'] : 0)), $this->config->get('config_currency')),
				'profit_margin_percent' 		=> $profit_margin_percent,
				'gsales'      					=> $result['sub_total']+$result['handling']+$result['low_order_fee']+$result['reward']+$result['coupon']+$result['credit']+$result['voucher']+($this->data['adv_profit_reports_formula_sop1'] ? $result['shipping'] : 0),
				'gcosts'      					=> $result['prod_costs']+$result['commission']+($this->data['adv_profit_reports_formula_sop3'] ? $result['payment_cost'] : 0)+($this->data['adv_profit_reports_formula_sop2'] ? $result['shipping_cost'] : 0),
				'gnetprofit'      				=> ($result['sub_total']+$result['handling']+$result['low_order_fee']+$result['reward']+$result['coupon']+$result['credit']+$result['voucher']+($this->data['adv_profit_reports_formula_sop1'] ? $result['shipping'] : 0))-($result['prod_costs']+$result['commission']+($this->data['adv_profit_reports_formula_sop3'] ? $result['payment_cost'] : 0)+($this->data['adv_profit_reports_formula_sop2'] ? $result['shipping_cost'] : 0)),
				...
				'total_sales_total'      		=> $this->currency->format($result['sub_total_total']+$result['handling_total']+$result['low_order_fee_total']+$result['reward_total']+$result['coupon_total']+$result['credit_total']+$result['voucher_total']+($this->data['adv_profit_reports_formula_sop1'] ? $result['shipping_total'] : 0), $this->config->get('config_currency')),
				...
				'total_costs_total'      		=> $this->currency->format('-' . ($result['prod_costs_total']+$result['commission_total']+($this->data['adv_profit_reports_formula_sop3'] ? $result['pay_costs_total'] : 0)+($this->data['adv_profit_reports_formula_sop2'] ? $result['ship_costs_total'] : 0)), $this->config->get('config_currency')),
				'netprofit_total'      			=> $this->currency->format(($result['sub_total_total']+$result['handling_total']+$result['low_order_fee_total']+$result['reward_total']+$result['coupon_total']+$result['credit_total']+$result['voucher_total']+($this->data['adv_profit_reports_formula_sop1'] ? $result['shipping_total'] : 0))-($result['prod_costs_total']+$result['commission_total']+($this->data['adv_profit_reports_formula_sop3'] ? $result['pay_costs_total'] : 0)+($this->data['adv_profit_reports_formula_sop2'] ? $result['ship_costs_total'] : 0)), $this->config->get('config_currency')),
