...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_display_option_value'] = $this->language->get('entry_display_option_value'); // Bukatoko
    ...
    // Bukatoko
		...
		$this->data['view_timer'] = $this->language->get('view_timer');
    ...
    // Catalog Size
    if (isset($this->request->post['config_catalog_size'])) {
			$this->data['config_catalog_size'] = $this->request->post['config_catalog_size'];
		} else {
			$this->data['config_catalog_size'] = $this->config->get('config_catalog_size');
		}
    ...
    // Bukatoko
    if (isset($this->request->post['config_timer'])) {
			$this->data['config_timer'] = $this->request->post['config_timer'];
		} else {
			$this->data['config_timer'] = $this->config->get('config_timer');
		}
    if (isset($this->request->post['config_attributes_on_product_page'])) {
			$this->data['config_attributes_on_product_page'] = $this->request->post['config_attributes_on_product_page'];
		} else {
			$this->data['config_attributes_on_product_page'] = $this->config->get('config_attributes_on_product_page');
		}
    // End
