...
// start SMS Module
			$this->data['entry_notifysms'] = $this->language->get('entry_notifysms');
			$this->data['entry_notifysmsdefaultsms'] = $this->config->get('rajasmsindo_defaultsms');
			$this->data['entry_notifysmsstatussms'] = $this->config->get('rajasmsindo_statussms');
// end SMS Module
			$this->data['entry_comment'] = $this->language->get('entry_comment');
	...
	public function invoice() {
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				$this->data['orders'][] = array(
					'logo'							 => HTTP_IMAGE . $this->config->get('config_logo'), // Bukatoko
					'order_id'	         => $order_id,
