...
$_['entry_api_key']				= 'API Key:<span class="help">You can find your API Key in MailChimp under:<br />(Your Account Name) > Account Settings > Extras > API Keys</span>';
...
$_['entry_newsletter_status']	= 'Newsletter Status Mapping:<span class="help">If desired, select a different customer group to which the customer is changed when subscribed or unsubscribed from your OpenCart newsletter. This customer group change will occur AFTER the "List Mapping" is executed.</span>';
