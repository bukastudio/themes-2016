...
class ModelReportAdvSaleProfitExport extends Model {
	public function getSaleProfitExport($data = array()) { 	
		...
		$sql .= ", (SELECT COUNT(o.order_id) FROM `" . DB_PREFIX . "order` o" . $date . $sdate . $osi . $store . $cur . $tax . $cgrp . $cust . $email . $tel . $pcomp . $paddr . $pcity . $pzone . $ppsc . $pcntr . $pmeth . $scomp . $saddr . $scity . $szone . $spsc . $scntr . $smeth . $cat . $manu . $sku . $prod . $mod . $opt . $atr . $loc  . $affn . $affe . $cpn . $cpc . $gvc . ") AS orders_total, 
		(SELECT COUNT(DISTINCT CONCAT(o.lastname, ', ', o.firstname)) FROM `" . DB_PREFIX . "order` o" . $date . $sdate . $osi . $store . $cur . $tax . $cgrp . $cust . $email . $tel . $pcomp . $paddr . $pcity . $pzone . $ppsc . $pcntr . $pmeth . $scomp . $saddr . $scity . $szone . $spsc . $scntr . $smeth . $cat . $manu . $sku . $prod . $mod . $opt . $atr . $loc  . $affn . $affe . $cpn . $cpc . $gvc . ") AS customers_total, 
		(SELECT SUM(op.quantity) FROM `" . DB_PREFIX . "order_product` op, `" . DB_PREFIX . "order` o" . $date . $sdate . $osi . $store . $cur . $tax . $cgrp . $cust . $email . $tel . $pcomp . $paddr . $pcity . $pzone . $ppsc . $pcntr . $pmeth . $scomp . $saddr . $scity . $szone . $spsc . $scntr . $smeth . $cat . $manu . $sku . $prod . $mod . $opt . $atr . $loc  . $affn . $affe . $cpn . $cpc . $gvc . " AND op.order_id = o.order_id) AS products_total, 
		IFNULL((SELECT SUM(ot.value) FROM `" . DB_PREFIX . "order_total` ot, `" . DB_PREFIX . "order` o" . $date . $sdate . $osi . $store . $cur . $tax . $cgrp . $cust . $email . $tel . $pcomp . $paddr . $pcity . $pzone . $ppsc . $pcntr . $pmeth . $scomp . $saddr . $scity . $szone . $spsc . $scntr . $smeth . $cat . $manu . $sku . $prod . $mod . $opt . $atr . $loc  . $affn . $affe . $cpn . $cpc . $gvc . " AND ot.order_id = o.order_id AND ot.code = 'sub_total'),0) AS sub_total_total, 
		...
		(SELECT SUM(o.total) FROM `" . DB_PREFIX . "order` o" . $date . $sdate . $osi . $store . $cur . $tax . $cgrp . $cust . $email . $tel . $pcomp . $paddr . $pcity . $pzone . $ppsc . $pcntr . $pmeth . $scomp . $saddr . $scity . $szone . $spsc . $scntr . $smeth . $cat . $manu . $sku . $prod . $mod . $opt . $atr . $loc  . $affn . $affe . $cpn . $cpc . $gvc . ") AS total_total, 
		(SELECT SUM(op.cost*op.quantity) FROM `" . DB_PREFIX . "order_product` op, `" . DB_PREFIX . "order` o" . $date . $sdate . $osi . $store . $cur . $tax . $cgrp . $cust . $email . $tel . $pcomp . $paddr . $pcity . $pzone . $ppsc . $pcntr . $pmeth . $scomp . $saddr . $scity . $szone . $spsc . $scntr . $smeth . $cat . $manu . $sku . $prod . $mod . $opt . $atr . $loc  . $affn . $affe . $cpn . $cpc . $gvc . " AND op.order_id = o.order_id) AS prod_costs_total, 
		(SELECT SUM(o.commission) FROM `" . DB_PREFIX . "order` o" . $date . $sdate . $osi . $store . $cur . $tax . $cgrp . $cust . $email . $tel . $pcomp . $paddr . $pcity . $pzone . $ppsc . $pcntr . $pmeth . $scomp . $saddr . $scity . $szone . $spsc . $scntr . $smeth . $cat . $manu . $sku . $prod . $mod . $opt . $atr . $loc  . $affn . $affe . $cpn . $cpc . $gvc . ") AS commission_total, 
		(SELECT SUM(o.payment_cost) FROM `" . DB_PREFIX . "order` o" . $date . $sdate . $osi . $store . $cur . $tax . $cgrp . $cust . $email . $tel . $pcomp . $paddr . $pcity . $pzone . $ppsc . $pcntr . $pmeth . $scomp . $saddr . $scity . $szone . $spsc . $scntr . $smeth . $cat . $manu . $sku . $prod . $mod . $opt . $atr . $loc  . $affn . $affe . $cpn . $cpc . $gvc . ") AS pay_costs_total, 
		(SELECT SUM(o.shipping_cost) FROM `" . DB_PREFIX . "order` o" . $date . $sdate . $osi . $store . $cur . $tax . $cgrp . $cust . $email . $tel . $pcomp . $paddr . $pcity . $pzone . $ppsc . $pcntr . $pmeth . $scomp . $saddr . $scity . $szone . $spsc . $scntr . $smeth . $cat . $manu . $sku . $prod . $mod . $opt . $atr . $loc  . $affn . $affe . $cpn . $cpc . $gvc . ") AS ship_costs_total ";
		
		$sql .= " FROM `" . DB_PREFIX . "order` o" . $date . $sdate . $osi . $store . $cur . $tax . $cgrp . $cust . $email . $tel . $pcomp . $paddr . $pcity . $pzone . $ppsc . $pcntr . $pmeth . $scomp . $saddr . $scity . $szone . $spsc . $scntr . $smeth . $cat . $manu . $sku . $prod . $mod . $opt . $atr . $loc  . $affn . $affe . $cpn . $cpc . $gvc;
