...
class ControllerProductNewArrivals extends Controller {
  public function index() {
    $this->language->load('product/new_arrivals');
    ...
    $this->data['sorts'][] = array(
      ...
      'value' => 'ps.price-ASC',
      'href'  => $this->url->link('product/new_arrivals', 'sort=ps.price&order=ASC' . $url)
    );

    $this->data['sorts'][] = array(
      'text'  => $this->language->get('text_price_desc'),
      'value' => 'ps.price-DESC',
      'href'  => $this->url->link('product/new_arrivals', 'sort=ps.price&order=DESC' . $url)
    );
    ...
    if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/new_arrivals.tpl')) {
      $this->template = $this->config->get('config_template') . '/template/product/new_arrivals.tpl';
    } else {
      $this->template = 'default/template/product/new_arrivals.tpl';
    }
