		...
		foreach ($categories as $category) {
			...
			foreach ($children as $child) {
				...
				$children_data[] = array(
					...
					'name'        => $child['name'] . ($this->config->get('config_product_count') ? ' <small>(' . $product_total . ')</small>' : ''),
			...
			$this->data['categories'][] = array(
				...
				'name'        => $category['name'] . ($this->config->get('config_product_count') ? ' <small>(' . $total . ')</small>' : ''),
