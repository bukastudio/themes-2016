...
<head>
  ...
  <link rel="stylesheet" type="text/css" media="all" href="<?php echo $base; ?>catalog/view/theme/nti/stylesheet/bukatoko.css" />
  ...
  <!-- /Main Script -->
  <script type="text/javascript" src="catalog/view/theme/nti/js/bukatoko-min.js"></script>
...
<body>
  ...
  <div class="container">
    <div class="headerSlot">
      ...
      <!-- Row-1 -->
      <div id="headerRow-1" class="headerRow">
        <div class="row">
      ...
      <!-- Row-2 -->
      <div id="headerRow-2" class="headerRow">
        <div id="mainMenu">
          <ul>
