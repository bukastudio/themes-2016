...
<head>
  ...
  <link rel="stylesheet" type="text/css" media="all" href="<?php echo $base; ?>catalog/view/theme/jazzgunung/stylesheet/bukatoko.css" />
  ...
  <!-- /Main Script -->
  <script type="text/javascript" src="catalog/view/theme/jazzgunung/js/bukatoko-min.js"></script>
