...
<div class="simplecheckout-block-content">
    ...
    <?php if ($simple_show_errors && $error_warning) { ?>
        <div class="simplecheckout-warning-block alert warning"><?php echo $error_warning ?></div>
    <?php } ?>

    <div class="simple-description"><p>Please select the preferred shipping method to use on this order.</p></div>
