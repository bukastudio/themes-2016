...
<!-- /CONTENT -->
<div id="content-slot" class="checkout-page <?php echo $slotclass ;?>">
      ...
      <div id="main-content">
        ...
        <h1><?php echo $heading_title; ?></h1>
				...
				<div class="checkout">
				  ...
				  <?php } else { ?>
				  <div id="payment-address" class="active">
...
$('.checkout-heading a').live('click', function() {
	...
	// Bukatoko
	$('.checkout > div').removeClass('active');
...
$('#button-account').live('click', function() {
	$.ajax({
		...
		success: function(html) {
			...
			$('#payment-address').addClass('active');
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
		}
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#payment-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<i class="icon-close"></i></div>');
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#shipping-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<i class="icon-close"></i></div>');
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#shipping-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<i class="icon-close"></i></div>');
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#payment-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<i class="icon-close"></i></div>');
