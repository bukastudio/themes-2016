...
<div id="categoryPage" class="contentSlot">
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="columnCenter">
          ...
          <div class="categoryHeader">
            <?php if ($thumb && $description) { ?><img class="categoryImage" src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" /><?php } ?>
                      ...
                      <div class="column">
                        ...
                        <?php for (; $i < $j; $i++) { ?>
                          <?php if (isset($categories[$i])) { ?>
                            <div><img width="16" height="16" src="data:image/png;base64," alt="Folder"><a href="<?php echo $categories[$i]['href']; ?>"><?php echo $categories[$i]['name']; ?></a></div>
                          <?php } ?>
                        <?php } ?>
                      </div>
                    <?php } ?>
