...
<div id="passwordPage" class="contentSlot">
  <div class="container">
                ...
                <form class="form--horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                  <fieldset>
                    <div class="form-group">
                      ...
                      <div class="form-control"><input type="password" name="password" value="<?php echo $password; ?>" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-control"><input type="password" name="confirm" value="<?php echo $confirm; ?>" /><?php if ($error_confirm) { ?>
