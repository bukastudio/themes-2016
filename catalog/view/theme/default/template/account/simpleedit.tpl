                    ...
                    <tr>
                        ...
                        <td class="simplecheckout-customer-right">
                          <div class="button-block">
                            <a onclick="$('#simple_edit_account').val(1);$('#simpleedit').submit();" class="button"><span><?php echo $button_continue; ?></span></a> <a href="<?php echo $back; ?>" class="button btn--neutral"><span><?php echo $button_back; ?></span></a>
                          </div>
                        </td>
                    </tr>
