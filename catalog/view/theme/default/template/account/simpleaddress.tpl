                    ...
                    <tr>
                        ...
                        <td class="simplecheckout-customer-right">
                          <div class="button-block">
                            <a onclick="$('#simpleaddress').submit();" class="button"><span><?php echo $button_continue; ?></span></a>   <a href="<?php echo $back; ?>" class="button btn--neutral "><span><?php echo $button_back; ?></span></a>
                          </div>
                        </td>
                    </tr>
