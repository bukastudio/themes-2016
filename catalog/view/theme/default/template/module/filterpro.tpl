...
<div class="box-heading"><?php echo $heading_title; ?><a class="clear_filter"><i class="icon-close"></i><?php echo $clear_filter?></a></div>
<div class="box-content filterpro">
<form id="filterpro">

<div class="option_box" <?php if(!$instock_visible) echo 'style="display:none"'; ?>>
	<label for="instock"><input type="checkbox" class="filtered" name="instock" id="instock" <?php if($instock_checked) echo 'checked="checked"'; ?>>&nbsp;&nbsp;&nbsp;<?php echo $text_instock?></label>
</div>
...
<div class="option_name"><?php echo $text_price_range?> <?php if($symbol_left){ echo "( ". $symbol_left  . ")";}?><?php if($symbol_right){ echo "(" . $symbol_right . " )";}?></div>
