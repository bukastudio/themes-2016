...
function success(g, b) {
    ...
    if (g.result_html) {
        if(g.result_html.list && g.result_html.grid){
            $(".catalog-list").html(g.result_html.list);
            $(".catalog-grid").html(g.result_html.grid);
        } else {
    ...
    if (g.totals_data) {
        ...
        $('.a_name').each(function (k, v) {
            ...
            if (atts[at_v_i]) {
                ...
                $(v).parent().siblings().children().removeClass("sublime");
            } else {
                $('[at_v_t="' + at_v_i_e + '"]').text($('[at_v_t="' + at_v_i_e + '"]').attr('data-value'));
                $(v).attr("disabled", "disabled");
                $(v).parent().siblings().children().addClass("sublime");
